...
export const serializeHeader = (version: number, numberOfEntries: number): Buffer => {
...
export const serializeIndex = (index: {
  ...
  const content = Buffer.concat(
    index.rawExtensions ? [header, entries, index.rawExtensions] : [header, entries]
  );
